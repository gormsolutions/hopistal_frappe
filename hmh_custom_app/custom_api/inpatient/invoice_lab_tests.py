...
def on_submit(doc, method):
    if doc.lab_test_prescription:
        try:
            ...
            patient_doc = frappe.get_doc('Patient', doc.patient_id)
            ...
            if existing_invoice:
                ...
                sales_invoice.posting_date = doc.admission_date
                
                # Handle None values for due_date
                encounter_date = doc.admission_date or frappe.utils.nowdate()
                custom_due_date = doc.admission_date or encounter_date
                ...
                sales_invoice.patient = doc.patient_id
                sales_invoice.set_posting_time = 1
                sales_invoice.posting_date = doc.admission_date
                ...
                sales_invoice.cost_center = doc.cost_center
                sales_invoice.inpatient_record_id = doc.name
                ...
                if  doc:
                    for lab_test in doc.lab_test_prescription:
                        if lab_test.custom_lab_status != "Fully Paid" or lab_test.custom_invoice_status != "Invoice Created":
                            ...
                            lab_test_doc.custom_inpatient_record_id = doc.name
                            lab_test_doc.date = doc.admission_date
                            lab_test_doc.practitioner = doc.doctor
